                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a data-scroll-nav="0" href="#testimonial">Contact</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-30">
                        <h5 class="mb-15">OUR PERFECTIONS</h5>
                        <h3 class="title mb-15"></h3>
                        <p>Beli Produk Kami Diskonnya Tiap Hari!! Jadi Tunggu Apa Lagi </p>
                    </div> <!-- section title -->
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            <img src="assets/images/services/boba.jpg" alt="">
                        </div> <!-- services btn -->
                    </div> <!-- services left -->
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center">
                                    ...
                                    <div class="services-content mt-20">
                                        <h5 class="title mb-10">Boba Milk Tea</h5>
                                        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm od tempor.</p> -->
                                        <li>boba kenyal</li>
                                        <li>senasi susu dan teh</li>
                                        <li>tinggi kalsium</li>
                                        <li>diolah dengan bahan pilihan </li>
                                        <li>100% halal</li>
